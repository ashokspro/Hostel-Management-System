...
function ManageSecurity() {
    ...
    async function saveEdit(formData) {
        ...
        try {
            ...
            toast.success('Security staff updated!');
            setEditing(null);
            load();
        } catch (err) {
    ...
    if (loading) return <LoadingSpinner text="Loading security staff..." />;

    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h1 className="text-xl font-bold text-gray-800">👮 Security Staff</h1>
                <button onClick={load}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-x-auto">
                {staff.length === 0 ? (
                    <div className="text-center py-12 text-gray-400">
                        ...
                        <p className="text-sm">No security staff found.</p>
                    </div>
                ) : (
